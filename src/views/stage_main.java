 ...
 * @author NTN
 */
public class stage_main extends Stage {
...
MediaPlayer mediaplayer;
    ...
    private void initialize() {
        ...
        //Split Pane Left
        TableView tbl_song = new TableView();
        ScrollPane scrollpane_tbl_song = new ScrollPane(tbl_song);
        left_pane.getChildren().add(scrollpane_tbl_song);
        ...
        tbl_song.getColumns().addAll(codeColumn,titleColumn);
        
        AnchorPane.setTopAnchor(scrollpane_tbl_song, 0.0);
        AnchorPane.setBottomAnchor(scrollpane_tbl_song, 0.0);
        AnchorPane.setRightAnchor(scrollpane_tbl_song, 0.0);
        AnchorPane.setLeftAnchor(scrollpane_tbl_song, 0.0);
                
        
        //Split Pane Right
        BorderPane right_pane_border = new BorderPane();
        
        String MEDIA_URL = "file:/D://ComingHome.mp3";
        mediaplayer = new MediaPlayer(new Media(MEDIA_URL));
        mediaplayer.setAutoPlay(false);
        MediaControl mediacontrol = new MediaControl(mediaplayer);
        right_pane.getChildren().add(right_pane_border);
        right_pane_border.setCenter(mediacontrol);
        //Test
...
public class MediaControl extends BorderPane {
        ...
        private final Image PlayButtonImage = new Image(stage_main.class.getResourceAsStream("playbutton.png"));
        private final Image PauseButtonImage = new Image(stage_main.class.getResourceAsStream("pausebutton.png"));
